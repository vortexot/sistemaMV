        ...
        <div className="grid gap-0 sm:grid-cols-2">
          ...
          >
            ...
            <span className="pointer-events-none absolute bottom-3 right-3 flex items-center gap-1.5 rounded-full bg-[#0B0B0B]/75 px-3 py-1 text-[10px] font-semibold uppercase tracking-wider text-[#DAA520] backdrop-blur">
              <ZoomIn className="h-3 w-3" /> {zoomed ? "Zoom ativo" : "Toque para ampliar"}
            </span>
          </div>
          ...
          <div className="flex flex-col p-6">
            ...
            {product.sizes.length > 0 && (
              <div className="mt-5">
                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-white">Tamanhos informados</p>
                <p className="mt-2 text-sm text-[#BDBDBD]">{product.sizes.join(" · ")}</p>
              </div>
            )}

            {product.colors.length > 0 && (
              <div className="mt-4">
                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-white">Cores informadas</p>
                <p className="mt-2 text-sm text-[#BDBDBD]">{product.colors.join(" · ")}</p>
              </div>
            )}
